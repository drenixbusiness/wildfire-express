...
const ROLES = [
  ...
  },
  {
    ...
    tagClass: "tag-blue" as const,
    title: "Lease Partner",
    sub: "Run a small fleet under Wild Fire authority. Built for growth.",
    pay: "$25K – $80K+",
    ...
    <section className="wf-section roles-band">
      <div className="wf-container">
        <Reveal>
          <div className="section-head">
            ...
            <p className="head-text">
              ...
              are real ranges — what people on each path actually earn at Wild Fire
        ...
        <div className="roles">
          {ROLES.map((r) => (
            <Reveal key={r.title}>
              <div className={`role${r.featured ? " featured" : ""}`}>
